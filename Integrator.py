class Integrator: 
    ...
    def rungeKutta(self, x0, f, dz, I=[0], N=None, eventbool=False, eventexp=None, terminalevent=0, optvar=None, Nmax=None):# butcher='rk4',):
        """
        ...
        x = []
        y = []
        h = dz if (I[1] == None or Nnotgiven) else (I[1] - I[0]) / N
        t0 = t
        ...
        if not tend:
            ...
            if Nmax is None:
                print('(x0, f, dz=', dz,', I=', I, ', N=', N, ', eventbool=', eventbool, ', [eventexp,terminalevent=0,optvar]=[', eventexp, terminalevent, optvar, '], Nmax=', Nmax, ')')
        ...
        while t <= tend:# Optimization doesn't work for ODEs plotted using time
