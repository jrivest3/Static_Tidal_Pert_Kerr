...
class Spacetime:
    ...
    def __init__(self,M,a,z_array,ell) -> None:
        thisST=self
        # Relavent sYlm's
        self.M=M
        self.a=a
    ...
    def TotalGamma(radius,theta,phi,z_array=None):
        '''
        ...
        Default z_array is None, which returns only background Christoffel symbols.
